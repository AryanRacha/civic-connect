...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-6 lg:space-y-8 order-1">
              <div className="space-y-4 lg:space-y-6">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 leading-relaxed animate-fade-in-up-delay max-w-2xl">
                  Your Voice. Your Community. Our Priority. A transparent and
                  efficient platform for civic grievance redressal.
                </p>
              </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 mb-2 text-sm sm:text-base">
                        Problem: Fragmented civic systems lead to delays &
                        citizen dissatisfaction
                      </h3>
                      <p className="text-gray-700 text-xs sm:text-sm">
                        Current systems lack transparency, accountability, and
                        efficient communication between citizens and government.
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="relative animate-fade-in-right mt-8 lg:mt-0 order-2">
              <div className="bg-gradient-to-br from-blue-100 via-teal-100 to-cyan-100 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-blue-200">
                <img
                  ...
                  style={{
                    filter:
                      "hue-rotate(200deg) saturate(1.3) brightness(1.1) contrast(1.2)",
                  }}
                />
              </div>
              {/* Floating elements */}
      ...
      <section
        id="how-it-works"
        className="bg-gradient-to-br from-gray-50 to-blue-50 py-12 sm:py-16 lg:py-20 xl:py-32"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 sm:space-y-6 mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our system streamlines the entire process, from a citizen's
              complaint to a verified resolution.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center max-w-6xl mx-auto space-y-8 lg:space-y-0 lg:space-x-8 xl:space-x-16">
            ...
            <div className="flex flex-col items-center space-y-4 sm:space-y-6 group">
              ...
              <div className="text-center max-w-xs">
                ...
                <p className="text-gray-600 text-sm">
                  Citizens submit issues with photos and location data
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 sm:space-y-6 group">
              ...
              <div className="text-center max-w-xs">
                ...
                <p className="text-gray-600 text-sm">
                  AI categorizes and assigns to relevant departments
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 sm:space-y-6 group">
              ...
              <div className="text-center max-w-xs">
                ...
                <p className="text-gray-600 text-sm">
                  Officials resolve issues with citizen verification
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        id="features"
        className="py-12 sm:py-16 lg:py-20 xl:py-32 overflow-hidden"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 sm:space-y-6 mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900">
            ...
            <div className="flex animate-scroll space-x-6 sm:space-x-8">
              ...
              <Card className="flex-shrink-0 w-72 sm:w-80 p-6 sm:p-8 hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                <CardContent className="p-0 space-y-4 sm:space-y-6">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    Aadhaar/DigiLocker verified authentication for trusted
              ...
              <Card className="flex-shrink-0 w-72 sm:w-80 p-6 sm:p-8 hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                <CardContent className="p-0 space-y-4 sm:space-y-6">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    Intelligent guidance and instant support for reporting
                    issues.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="flex-shrink-0 w-72 sm:w-80 p-6 sm:p-8 hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                <CardContent className="p-0 space-y-4 sm:space-y-6">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    Report and work without internet connection for remote
                    areas.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="flex-shrink-0 w-72 sm:w-80 p-6 sm:p-8 hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                <CardContent className="p-0 space-y-4 sm:space-y-6">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                    Automatic alerts ensuring accountability and timely
                    resolution.
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <div className="space-y-6 sm:space-y-8 lg:space-y-10">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              This project for the Smart India Hackathon aims to redefine civic
              governance. Built with React, Node.js, and MongoDB, we offer a
              scalable and impactful solution.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-12 mb-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed">
                Empowering citizens and building better communities through
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400 text-sm sm:text-base">
              © 2024 Civic Grievance Redressal System. Built for Smart India
              Hackathon.
            </p>
          </div>
        </div>
